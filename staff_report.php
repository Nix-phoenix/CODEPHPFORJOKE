...
$employees = [];
$sql = "SELECT emp_id, emp_name, tel, address FROM Employee ORDER BY emp_id ASC";
...
<div class="receipt-container">
    ...
    <h2 class="receipt-title">ໃບລາຍງານຂໍ້ມູນພະນັກງານ<br>Employee Data Report Receipt</h2>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-left"><?php echo htmlspecialchars($employee['emp_name']); ?></td>
                    <td><?php echo htmlspecialchars($employee['tel']); ?></td>
                    <td class="text-left"><?php echo htmlspecialchars($employee['address']); ?></td>
                </tr>
            <?php 
                endforeach;
            else: 
            ?>
                <tr>
                    <td colspan="4">ບໍ່ມີຂໍ້ມູນພະນັກງານ.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
