...
$products = [];
$sql = "SELECT p_id, p_name, type, unit, price, qty, shelf FROM Product ORDER BY p_id ASC";
    ...
    <table class="receipt-table">
        ...
        <tbody>
            ...
            <?php if (empty($products)): ?>
                <tr>
                    <td colspan="8">ບໍ່ມີຂໍ້ມູນສິນຄ້າໃນລະບົບ.</td>
                </tr>
            <?php else: ?>
                <tr>
                    <td colspan="6" style="text-align:right;font-weight:bold;">ມູນຄ່າສິນຄ້າທັງໝົດ</td>
