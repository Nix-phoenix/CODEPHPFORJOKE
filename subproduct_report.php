...
<head>
    ...
    <title>ລາຍງານໃບບິນນໍາເຂົ້າສິນຄ້າ</title>
...
<div class="receipt-container">
    ...
    <h2 class="receipt-title">ໃບລາຍງານໃບບິນນໍາເຂົ້າສິນຄ້າ<br>Product Import Report Receipt</h2>
        ...
        <tbody>
            ...
            if (!empty($imports)):
                ...
                foreach ($imports as $import):
                    $grandTotal += (float)$import['total_price'];
            ?>
                <tr>
