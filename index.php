...
$latest_sales = $conn->query("
    SELECT s.s_id, s.c_id, c.c_name, sd.p_id, p.p_name, sd.qty, sd.total_price, s.status, pm.date AS payment_date
    FROM Sell s
    ...
    <div id="editOrderModal" class="modal" style="display:none;">
        <div class="modal-content">
            ...
            <form id="editOrderForm" method="post">
                ...
                <label>ສະຖານະ</label>
                <select name="status" id="edit_status" class="dashboard-input" style="width:100%;margin-bottom:10px;">
