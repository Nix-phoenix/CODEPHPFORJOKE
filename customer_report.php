...
// Fetch customer data from the database using the correct column name 'tel'
$customers = [];
$sql = "SELECT c_id, c_name, tel, address FROM Customer ORDER BY c_id ASC";
...
<div class="receipt-container">
    ...
    <h2 class="receipt-title">ໃບລາຍງານຂໍ້ມູນລູກຄ້າ<br>Customer Data Report Receipt</h2>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-left"><?php echo htmlspecialchars($customer['c_name']); ?></td>
                    <td><?php echo htmlspecialchars($customer['tel']); ?></td>
                    <td class="text-left"><?php echo htmlspecialchars($customer['address']); ?></td>
                </tr>
            <?php 
                endforeach;
            else: 
            ?>
                <tr>
                    <td colspan="4">ບໍ່ມີຂໍ້ມູນລູກຄ້າ.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
